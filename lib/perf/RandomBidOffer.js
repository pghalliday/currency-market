(function() {
  var Account, Amount, Market, Order, RandomBidOffer, TIMESTAMP, nextTransactionId, poisson, transactionId,
  ...
  module.exports = RandomBidOffer = (function() {
    function RandomBidOffer(params) {
    ...
    RandomBidOffer.prototype.execute = function() {
      var startTime,
        _this = this;
