  ...
  module.exports = Balance = (function() {
    function Balance(params) {
      ...
      this["export"] = __bind(this["export"], this);      if (typeof params === 'undefined') {
        ...
        this.funds = new Amount(params.state.funds);
        this.lockedFunds = new Amount(params.state.lockedFunds);
      }
    }
    ...
    Balance.prototype["export"] = function() {
      ...
      state.funds = this.funds.toString();
      state.lockedFunds = this.lockedFunds.toString();
      return state;
    };
