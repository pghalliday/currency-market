  ...
  module.exports = CurrencyMarket = (function(_super) {
    ...
    CurrencyMarket.prototype.register = function(params) {
      if (this.accounts[params.key]) {
        ...
        this.lastTransaction = params.id;
    ...
    CurrencyMarket.prototype.submit = function(order) {
    ...
    CurrencyMarket.prototype.cancel = function(cancellation) {
      var order;
    ...
    CurrencyMarket.prototype.equals = function(currencyMarket) {
      ...
      if (typeof this.lastTransaction === 'undefined') {
        ...
        if (this.lastTransaction !== currencyMarket.lastTransaction) {
          equal = false;
        }
      }
      if (equal) {
          ...
          if (equal) {
            ...
            if (equal) {
              ...
              if (equal) {
                ...
                if (equal) {
                  Object.keys(currencyMarket.books).forEach(function(bidCurrency) {
                    if (Object.keys(_this.books).indexOf(bidCurrency) === -1) {
                      ...
                      if (equal) {
                        return Object.keys(currencyMarket.books[bidCurrency]).forEach(function(offerCurrency) {
                          if (Object.keys(_this.books[bidCurrency]).indexOf(offerCurrency) === -1) {
                            return equal = false;
                          } else {
                            if (!_this.books[bidCurrency][offerCurrency].equals(currencyMarket.books[bidCurrency][offerCurrency])) {
                              return equal = false;
                            }
                          }
                        });
