(function() {
  ...
  module.exports = Order = (function(_super) {
    ...
    function Order(params) {
      ...
      this.bidBalance = params.bidBalance;
      if (!this.bidBalance) {
        throw new Error('Order must be associated with a bid balance');
      }
      this.offerBalance = params.offerBalance;
      if (!this.offerBalance) {
      ...
      this.offerBalance.lock(this.offerAmount);
    }
    ...
    Order.prototype.match = function(order) {
      var compareAmounts, leftBalanceDeltas, leftOfferAmount, price, rightBalanceDeltas, rightOfferAmount;
            ...
            if (compareAmounts > 0) {
              ...
              order.emit('trade', {
                ...
                left: {
                  ...
                  newOfferAmount: this.offerAmount,
    ...
    Order.prototype["export"] = function() {
      ...
      object.bidCurrency = this.bidBalance.currency;
      object.offerCurrency = this.offerBalance.currency;
      if (this.bidPrice) {
