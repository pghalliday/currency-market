(function() {
  ...
  module.exports = Engine = (function() {
    function Engine(params) {
      ...
      var account, accountObject, balance, bidCurrency, book, books, currency, id, offerCurrency, order, snapshot, _fn, _i, _len, _ref, _ref1, _ref2,
        _this = this;
      ...
      if (params) {
        ...
        if (params.json) {
          ...
          this.nextDeltaSequence = snapshot.nextDeltaSequence;
        }
      }
    }
