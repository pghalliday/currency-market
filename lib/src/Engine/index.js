(function() {
  var Account, Amount, Book, Delta, Engine, Order,
  ...
  module.exports = Engine = (function() {
    ...
    Engine.prototype.apply = function(operation) {
      var account, delta, deposit, leftBook, lockedFunds, nextHigher, order, rightBook, sequence, submit, timestamp, withdraw;
      ...
      if (typeof sequence === 'undefined') {
        ...
        if (typeof timestamp === 'undefined') {
          ...
          if (sequence === this.nextOperationSequence) {
