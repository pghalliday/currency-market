(function() {
  ...
  module.exports = Order = (function(_super) {
    ...
    Order.prototype.exportList = function(array) {
      array.push(this["export"]());
      if (this.lower) {
        this.lower.getHighest().exportList(array);
      }
      if (this.parent) {
        if (this.parent.higher === this) {
          array.push(this.parent["export"]());
          if (this.parent.lower) {
            return this.parent.lower.getHighest().exportList(array);
          }
        }
      }
    };
