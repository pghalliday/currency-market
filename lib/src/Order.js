(function() {
  ...
  module.exports = Order = (function(_super) {
    ...
    function Order(params) {
      ...
      this["export"] = __bind(this["export"], this);      this.id = params.id;
      if (!this.id) {
    ...
    Order.prototype["export"] = function() {
      ...
      params.bidCurrency = this.bidCurrency;
      params.offerCurrency = this.offerCurrency;
      if (this.bidPrice) {
        params.bidPrice = this.bidPrice;
        params.bidAmount = this.bidAmount;
      } else {
        params.offerPrice = this.offerPrice;
        params.offerAmount = this.offerAmount;
      }
      return params;
    };
