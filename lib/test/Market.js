(function() {
  var Account, Amount, Balance, Book, Market, Order, amount1, amount10, amount100, amount1000, amount101, amount125, amount1250, amount150, amount1500, amount1750, amount20, amount200, amount2000, amount250, amount2500, amount300, amount350, amount4, amount400, amount475, amount4950, amount5, amount50, amount500, amount525, amount650, amount750, amount99, amountPoint2, amountPoint25, amountPoint5, assert, chai, expect, sinon, sinonChai;
  ...
  describe('Market', function() {
    ...
    it('should instantiate with empty collections of accounts and books', function() {
      Object.keys(this.market.accounts).should.be.empty;
      return Object.keys(this.market.books).should.be.empty;
    });
            ...
            describe('and the left order is a bid', function() {
              describe('and the right order is offering exactly the amount the left order is bidding', function() {
                return it('should trade the amount the right order is offering and emit a trade event', function() {
                  ...
                  this.market.getAccount('Peter').getBalance('BTC').funds.compareTo(amount200).should.equal(0);
                  this.market.getAccount('Paul').getBalance('EUR').funds.compareTo(amount1000).should.equal(0);
              ...
              describe('and the right order is offering more than the left order is bidding', function() {
                return it('should trade the amount the left order is offering and emit a trade event', function() {
                  ...
                  this.market.getAccount('Peter').getBalance('BTC').funds.compareTo(amount100).should.equal(0);
                  this.market.getAccount('Paul').getBalance('EUR').funds.compareTo(amount500).should.equal(0);
      ...
      describe('when multiple orders can be matched', function() {
        ...
        describe('and the last order can be completely satisfied', function() {
          return it('should correctly execute as many orders as it can and emit trade events', function() {
            ...
            this.market.getAccount('Peter').getBalance('BTC').funds.compareTo(amount350).should.equal(0);
            this.market.getAccount('Paul').getBalance('EUR').funds.compareTo(amount1250).should.equal(0);
        ...
        return describe('and the last order cannot be completely satisfied', function() {
          return it('should correctly execute as many orders as it can and emit trade events', function() {
            ...
            this.market.getAccount('Peter').getBalance('EUR').lockedFunds.compareTo(amount500).should.equal(0);
            this.market.getAccount('Peter').getBalance('BTC').funds.compareTo(amount475).should.equal(0);
            this.market.getAccount('Paul').getBalance('EUR').funds.compareTo(amount1500).should.equal(0);
    ...
    return describe('#export', function() {
      ...
      return it('should be possible to recreate a market from an exported snapshot', function() {
        ...
        market = new Market(this.market["export"]());
        ...
        return market.getAccount('Paul').getBalance('BTC').funds.compareTo(Amount.ZERO).should.equal(0);
      });
    });
  });
