(function() {
  ...
  describe('Market', function() {
    ...
    describe('#submit', function() {
      ...
      it('should execute orders correctly and not throw a withdraw error when ? (captured from a failing performance test)', function() {
      ...
      return it('should execute orders correctly and not throw an unlock funds error when ? (captured from a failing performance test)', function() {
        this.market.register(newAccount('100000'));
        this.market.register(newAccount('100001'));
        this.market.register(newAccount('100002'));
        this.market.deposit({
