(function() {
  ...
  describe('Market', function() {
    ...
    describe('#submit', function() {
      ...
      return it.skip('should execute BID/BID orders correctly and not throw an unlock funds error when ? (captured from a failing random performance test)', function() {
        this.market.register(newAccount('100000'));
        this.market.register(newAccount('100001'));
        this.market.register(newAccount('100002'));
