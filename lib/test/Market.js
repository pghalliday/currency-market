(function() {
  ...
  describe('Market', function() {
    ...
    describe('#submit', function() {
          ...
          describe('and the new (left) price is same', function() {
            ...
            return describe('and the left order is an offer', function() {
              describe('and the right order is offering exactly the amount the left order is offering', function() {
                return it.skip('should trade the amount the right order is offering and emit a trade event', function(done) {
                  var checklist,
                    _this = this;
              ...
              describe('and the right order is offering more than the left order is offering', function() {
                return it.skip('should trade the amount the left order is offering and emit a trade event', function(done) {
                  var checklist,
                    _this = this;
          ...
          return describe('and the new (left) price is the better', function() {
            describe('and the left order is an offer', function() {
              describe('and the right order is offering exactly the amount that the left order is offering multiplied by the right order price', function() {
                return it.skip('should trade the amount the right order is offering at the right order price and emit a trade event', function(done) {
                  var checklist,
                    _this = this;
              ...
              describe('and the right order is offering more than the left order is offering multiplied by the right order price', function() {
                return it.skip('should trade the amount the left order is offering at the right order price and emit a trade event', function(done) {
                  var checklist,
                    _this = this;
          ...
          return describe('and the new (left) price is better', function() {
            ...
            return describe('and the left order is a bid', function() {
              describe('and the right order is bidding exactly the amount that the left order is bidding multiplied by the right order price', function() {
                return it.skip('should trade the amount the right order is bidding at the right order price and emit a trade event', function(done) {
                  var checklist,
                    _this = this;
              ...
              describe('and the right order is bidding more than the left order is bidding multiplied by the right order price', function() {
                return it.skip('should trade the amount the left order is bidding at the right order price and emit a trade event', function(done) {
                  var checklist,
                    _this = this;
      ...
      describe('when multiple orders can be matched', function() {
        ...
        describe('and the last order can be completely satisfied', function() {
          return it('should correctly execute as many orders as it can and emit trade events', function(done) {
            ...
            checklist = new Checklist(['5', '500', '0.2', '1', '100', '5', '5', '500', '0.25', '2', '125', '4', '5', '250', '0.5', '3', '125', '2'], {
              ordered: true
            }, function(error) {
              _this.market.removeAllListeners();
              return done(error);
        ...
        return describe('and the last order cannot be completely satisfied', function() {
          return it('should correctly execute as many orders as it can and emit trade events', function(done) {
            ...
            checklist = new Checklist(['5', '500', '0.2', '1', '100', '5', '5', '500', '0.25', '2', '125', '4', '5', '500', '0.5', '3', '250', '2'], {
              ordered: true
            }, function(error) {
              _this.market.removeAllListeners();
              return done(error);
      ...
      it('should execute orders correctly and not throw a withdraw error when ? (captured from a failing random performance test)', function() {
      ...
      return it('should execute orders correctly and not throw an unlock funds error when ? (captured from a failing random performance test)', function() {
        this.market.register(newAccount('100000'));
        this.market.register(newAccount('100001'));
        this.market.register(newAccount('100002'));
        this.market.deposit({
