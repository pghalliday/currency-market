(function() {
  ...
  describe('Market', function() {
    ...
    describe('#register', function() {
      ...
      it('should submit an account to the market with the supported currencies, record the last transaction ID and emit an account event', function(done) {
