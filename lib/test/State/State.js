(function() {
  ...
  describe('State', function() {
    ...
    it('should instantiate from an engine state', function() {
      var accountPaul, accountPeter, balancePaulBTC, balancePaulEUR, balancePeterBTC, balancePeterEUR, orderPaul6, orderPaul7, orderPeter4, orderPeter5, ordersPaul, ordersPeter, state;
      ...
      return orderPaul7.bidAmount.should.equal('1000');
    });
