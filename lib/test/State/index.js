    ...
    return describe('#apply', function() {
      ...
      describe('submit delta', function() {
        return it('should update the state accordingly', function() {
          var balance, bookEURBTC, order, state;
          state = state = new State({
            json: JSON.stringify(this.engine)
          });
          ...
          return state.apply(this.submitBid({
            account: 'Paul',
            offerCurrency: 'BTC',
            bidCurrency: 'EUR',
            price: '0.04',
      ...
      return describe('cancel delta', function() {
        return it.skip('should update the state accordingly', function() {
          var state;
          state = state = new State({
            json: JSON.stringify(this.engine)
          });
          ...
          return state.apply(this.cancel({
            account: 'Paul',
            sequence: 6
          }));
        });
