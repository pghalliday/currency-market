(function() {
  var Account, Amount, Balance, Order, amount10, amount100, amount1000, amount15, amount150, amount175, amount200, amount25, amount300, amount5, amount50, amount500, amountPoint01, assert, chai, expect, newBid, newOffer;
    ...
    describe('#submit', function() {
      ...
      return describe('when the order fill event fires', function() {
        ...
        it('should adjust the locked funds and make deposits and withdrawals to apply the fill', function() {
          ...
          this.account.getBalance('EUR').offers['1'].should.equal(this.order);
          ...
          return this.account.getBalance('BTC').funds.compareTo(amount5).should.equal(0);
        });
        return it('should delete fully filled orders', function() {
          ...
          order.match(this.order);
          expect(this.account.getBalance('EUR').offers['1']).to.not.be.ok;
