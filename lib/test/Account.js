    ...
    describe('#submit', function() {
      ...
      return describe('when the order fill event fires', function() {
        ...
        it('should adjust the locked funds, apply commission and make deposits and withdrawals to apply the fill', function() {
          ...
          this.calculateCommission.firstCall.args[0].bidAmount.compareTo(amount5).should.equal(0);
          this.calculateCommission.firstCall.args[0].timestamp.should.equal('2');
          this.calculateCommission.firstCall.args[0].bid.should.equal(this.order);
