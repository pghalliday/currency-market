  ...
  describe('Amount', function() {
    ...
    describe('#divide', function() {
      ...
      it('should round to 25 places', function() {
        ...
        return amountRatio.compareTo(amount2Thirds).should.equal(0, 'Ratio should be correct');
      });
    ...
    return describe('#toString', function() {
      return it('should return a string representation of the amount', function() {
        var amount;
