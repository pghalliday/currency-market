(function() {
  ...
  describe('Amount', function() {
    ...
    describe('#toString', function() {
      return it('should return a string that is suitable for exporting and later importing amounts', function() {
        var amount1, amount2;
    ...
    describe('JSON.stringify', function() {
      return it('should return a JSON string that is suitable for exporting and later importing amounts', function() {
        var amount1, amount2;
