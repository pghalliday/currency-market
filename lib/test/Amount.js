(function() {
  ...
  describe('Amount', function() {
    ...
    describe('#divide', function() {
      ...
      return it('should divide 1 by 100 and successfully compare to 0.01', function() {
    ...
    describe('#toString', function() {
      ...
      it('should round to 25 places', function() {
        var amount2, amount3, amountRatio;

        amount2 = new Amount('2');
        amount3 = new Amount('3');
        amountRatio = amount2.divide(amount3);
        return amountRatio.toString().should.equal('0.6666666666666666666666667');
      });
    ...
    return describe('#export', function() {
      return it('should export the state of the Amount as a JSON stringifiable object that can be used to initialise a new Amount in the exact same state', function() {
        var amount2, amount3, amountRatio, json, newAmount, state;
        ...
        return newAmount.compareTo(amountRatio).should.equal(0);
      });
    });
  });
