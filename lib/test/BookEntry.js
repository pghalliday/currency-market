(function() {
  var BookEntry, Order, assert, chai, expect, newBookEntry, sinon, sinonChai;
  ...
  describe('BookEntry', function() {
    ...
    describe('#add', function() {
      beforeEach(function() {
        this.bookEntry = newBookEntry('0.2');
        this.higherBookEntry = newBookEntry('1');
        this.evenHigherBookEntry = newBookEntry('2');
        this.equalBookEntry = newBookEntry('0.2');
        return this.secondEqualBookEntry = newBookEntry('0.2');
      });
    ...
    describe('#delete', function() {
      beforeEach(function() {
        this.bookEntry1 = newBookEntry('1');
        this.bookEntry2 = newBookEntry('2');
        this.bookEntry3 = newBookEntry('3');
        this.bookEntry4 = newBookEntry('4');
        this.bookEntry5 = newBookEntry('5');
        this.bookEntry6 = newBookEntry('6');
        this.bookEntry7 = newBookEntry('7');
        return this.bookEntry8 = newBookEntry('8');
      });
    ...
    describe('#equals', function() {
      beforeEach(function() {
        this.bookEntry1a = newBookEntry('1');
        this.bookEntry1b = newBookEntry('1');
        this.bookEntry2a = newBookEntry('2');
        this.bookEntry2b = newBookEntry('2');
        this.bookEntry3a = newBookEntry('3');
        this.bookEntry3b = newBookEntry('3');
        this.bookEntry4a = newBookEntry('4');
        this.bookEntry4b = newBookEntry('4');
        this.bookEntry5a = newBookEntry('5');
        this.bookEntry5b = newBookEntry('5');
        this.bookEntry6a = newBookEntry('6');
        this.bookEntry6b = newBookEntry('6');
        this.bookEntry7a = newBookEntry('7');
        this.bookEntry7b = newBookEntry('7');
        this.bookEntry8a = newBookEntry('8');
        return this.bookEntry8b = newBookEntry('8');
      });
