(function() {
  ...
  describe('CurrencyMarket', function() {
    return it('should be possible to construct an Engine, export the engine state to a State, apply an Operation and apply the resulting Delta to the State', function() {
