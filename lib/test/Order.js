(function() {
  ...
  describe('Order', function() {
    ...
    it('should instantiate with a bid price and bid amount calculating the offer amount and the offer price and set fillOffer to false', function() {
      var order;
      ...
      return order.fillOffer.should.be["false"];
    });
    it('should instantiate with an offer price and offer amount calculating the bid amount and the bid price and set fillOffer to true', function() {
      var order;
      ...
      return order.fillOffer.should.be["true"];
    });
    ...
    return describe('#reduceBid', function() {
