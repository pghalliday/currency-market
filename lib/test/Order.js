(function() {
  ...
  describe('Order', function() {
    ...
    return describe('#export', function() {
      return it('should export the an order so that a new order can be constructed with the same fields', function() {
        var bid, offer, order, params;
        ...
        return order.bidAmount.compareTo(offer.bidAmount).should.equal(0);
      });
    });
  });
