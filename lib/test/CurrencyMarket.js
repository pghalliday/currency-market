  ...
  describe('CurrencyMarket', function() {
    ...
    describe('#submit', function() {
      ...
      it('should record an order, submit it to the correct book and emit an order event', function(done) {
        ...
        checklist = new Checklist(['123456789', '987654321', 'Peter', 'BTC', 'EUR', '100', '50', 'undefined', 'undefined', '123456790', '987654322', 'Paul', 'EUR', 'BTC', 'undefined', 'undefined', '99', '50'], {
          ordered: true
        }, function(error) {
          _this.currencyMarket.removeAllListeners();
          return done(error);
        ...
        this.currencyMarket.books['BTC']['EUR'].highest.id.should.equal('123456789');
        this.currencyMarket.submit({
          id: '123456790',
          timestamp: '987654322',
          account: 'Paul',
        ...
        this.currencyMarket.orders['123456790'].should.be.ok;
        return this.currencyMarket.books['EUR']['BTC'].highest.id.should.equal('123456790');
      });
    ...
    describe('#cancel', function() {
      ...
      it('should remove the order from the orders collection and from the correct book and emit an cancellation event', function(done) {
        ...
        expect(this.currencyMarket.orders['123456790']).to.not.be.ok;
