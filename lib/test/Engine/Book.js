(function() {
  var Account, Amount, Book, Order, amount10, amount100, amount1000, amount15, amount48Point5, amount48Point75, amount49, amount49Point5, amount49Point75, amount5, amount50, amount50Point5, amount50Point75, amount51, amount52, amount53, amountPoint05, amountPoint1, assert, chai, expect;
  ...
  describe('Book', function() {
    ...
    describe('#submit', function() {
      ...
      return it('should handle bids and offers in the same book', function() {
        this.book.submit(this.newBid(amount10));
        this.book.submit(this.newOffer(amountPoint05));
        return this.book.submit(this.newBid(amount10));
      });
    });
    ...
    return describe('JSON.stringify', function() {
      return it('should return a JSON string containing an array of orders in the book sorted by bid price with the highest first', function() {
        ...
        json = JSON.stringify(this.book);
        array = JSON.parse(json);
        return array.should.deep.equal([JSON.parse(JSON.stringify(order15.toJSON())), JSON.parse(JSON.stringify(order4.toJSON())), JSON.parse(JSON.stringify(order14.toJSON())), JSON.parse(JSON.stringify(order2.toJSON())), JSON.parse(JSON.stringify(order13.toJSON())), JSON.parse(JSON.stringify(order5.toJSON())), JSON.parse(JSON.stringify(order12.toJSON())), JSON.parse(JSON.stringify(order1.toJSON())), JSON.parse(JSON.stringify(order11.toJSON())), JSON.parse(JSON.stringify(order6.toJSON())), JSON.parse(JSON.stringify(order10.toJSON())), JSON.parse(JSON.stringify(order3.toJSON())), JSON.parse(JSON.stringify(order9.toJSON())), JSON.parse(JSON.stringify(order7.toJSON())), JSON.parse(JSON.stringify(order8.toJSON()))]);
      });
    });
  });
