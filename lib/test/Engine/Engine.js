  ...
  describe('Engine', function() {
    ...
    describe('#apply', function() {
      ...
      describe('deposit', function() {
        ...
        return it('should credit the correct account and currency and return the delta sequence number', function() {
          var account, result;
          ...
          return result.sequence.should.equal(1);
        });
      });
      describe('withdraw', function() {
        ...
        return it('should debit the correct account and currency and return the delta sequence number unless the requested funds are not available', function() {
          var account, result,
            _this = this;
      ...
      describe('submit', function() {
        ...
        it('should record an order, submit it to the correct book and return the delta sequence number', function() {
          var result;
          ...
          this.engine.getBook('EUR', 'BTC').next().sequence.should.equal(3);
          result.sequence.should.equal(3);
          return result.nextHigherOrderSequence.should.equal(-1);
        });
        it('should trade matching orders', function() {
          var operation1, operation2, result;
          ...
          result = this.engine.apply(operation2);
        ...
        describe('when multiple orders can be matched', function() {
          ...
          describe('and the last order can be completely satisfied', function() {
            return it('should correctly execute as many orders as it can and return the delta information including transactions processed', function() {
              ...
              result = this.engine.apply(operation);
      ...
      return describe('cancel', function() {
        ...
        it('should remove the order from the orders collection and from the correct book, record the last transaction ID and emit an cancellation event', function() {
          ...
          return result.sequence.should.equal(5);
        });
