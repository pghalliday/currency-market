        ...
        describe('and the new (left) price is same', function() {
          describe('and the left order is a bid', function() {
            describe('and the right order is offering exactly the amount the left order is bidding', function() {
              return it('should trade the amount the right order is offering and return the transaction information', function() {
                var order, result;
                ...
                return result.trade.right.credit.commission.reference.should.equal('Peter commission level');
              });
            });
            describe('and the right order is offering more than the left order is bidding', function() {
              return it('should trade the amount the left order is offering and return the transaction information', function() {
                var order, result;
        ...
        return describe('and the new (left) price is the better', function() {
          describe('and the left order is an offer', function() {
            describe('and the right order is offering exactly the amount that the left order is offering multiplied by the right order price', function() {
              return it('should trade the amount the right order is offering at the right order price and return the transaction information', function() {
                var order, result;
            ...
            describe('and the right order is offering more than the left order is offering multiplied by the right order price', function() {
              return it('should trade the amount the left order is offering at the right order price and return the transaction information', function() {
                var order, result;
          ...
          return describe('and the left order is a bid', function() {
            ...
            describe('and the right order is offering more than the left order is bidding', function() {
              return it('should trade the amount the left order is bidding at the right order price and return the transaction information', function() {
                var order, result;
        ...
        return describe('and the new (left) price is better', function() {
          describe('and the left order is an offer', function() {
            describe('and the right order is bidding exactly the amount that the left order is offering', function() {
              return it('should trade the amount the right order is bidding at the right order price and return the transaction information', function() {
                var order, result;
