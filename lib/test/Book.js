(function() {
  ...
  describe('Book', function() {
    ...
    return describe('#export', function() {
      return it('should export the state of the book as a JSON stringifiable object that can be used to initialise a new Book in the exact same state and populate a collection of orders keyed by id', function() {
        var book, json, newBook, order1, order10, order11, order12, order13, order14, order15, order2, order3, order4, order5, order6, order7, order8, order9, orders, state;
        ...
        return orders['15'].equals(order15).should.be["true"];
      });
    });
  });
