(function() {
  ...
  describe('Submit', function() {
    return it.skip('should instantiate recording the supplied locked funds, next higher order sequence and trades', function() {
      var submit;
      ...
      submit.lockedFunds.compareTo(new Amount('1100')).should.equal(0);
      submit.nextHigherOrderSequence.should.equal(0);
      return submit.trades.should.deep.equal([]);
    });
  });
