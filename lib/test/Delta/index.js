(function() {
  var Cancel, Delta, Deposit, Operation, Submit, Withdraw, chai, expect;
  ...
  describe('Delta', function() {
    ...
    return describe('with operation of type deposit', function() {
      return it('should instantiate recording a supplied sequence number, operation and instantiate a Deposit', function() {
        ...
        return delta.result.funds.should.equal('1500');
      });
    });
  });
