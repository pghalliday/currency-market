(function() {
  ...
  describe('Operation', function() {
    ...
    return it('should instantiate recording a supplied reference, sequence number, timestamp, account and the operation', function() {
      var operation;
      ...
      return operation.cancel.should.equal('my cancel');
    });
  });
